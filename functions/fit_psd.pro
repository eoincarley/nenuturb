function fit_psd, frequency, power, pspecerr=pspecerr
        ...
        fit = 'p[0] + p[1]*x'
        err = power
        err[*] = pspecerr*abs(power) ; Equivalent to inverse weighting of the power.

        ; Note here that if I supply the weights keyword with poisson weighting (weights=1/power^2) the fit
        ...
        ; of a random sample of points is worse than calculated value.
        ; If <5% then the fit is in the worst 5th percentile, and should be rejected.
