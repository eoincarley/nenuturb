...
pro plot_goes_nenufar, save=save, postscript=postscript
	...
	; 	First spectrogram
	;
	READ_NU_SPEC, path+file, data,time,freq,beam,ndata,nt,dt,nf,df,ns, tmin=27*60.0, tmax=39*60.0
	...
	;-------------------------;
        ...
        plot_goes_20190320, '2019-03-20T10:00', '2019-03-20T13:00', position=pos, tlines=[utimes0[0], utimes0[-1], utimes1[-1]]
